...
ADD induction_script_with_args.py induction_script_with_args.py 
ADD induction_R_code.R induction_R_code.R
...
#Example Run Command
#CMD ["python3.9", "induction_script_with_args.py", "-f", "phage_reference_file.fasta", "-p" "R1.fastq R2.fastq", "-s" "sample_name", "-o", "/output_path/"]
